...
module.exports = angular
  .module('spinnaker.ecloud.serverGroup.details.securityGroup.editSecurityGroups.modal.controller', [
    SERVER_GROUP_WRITER,
    SECURITY_GROUP_READER,
  ])
  .controller('ecloudEditSecurityGroupsCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'securityGroupReader',
    ...
    function(
      ...
      securityGroupReader.getAllSecurityGroups().then(allGroups => {
        ...
        this.availableSecurityGroups = _.get(allGroups, [account, 'ecloud', region].join('.'), [])
