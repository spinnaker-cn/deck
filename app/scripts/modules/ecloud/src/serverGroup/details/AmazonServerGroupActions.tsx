...
import { IAmazonServerGroup, IAmazonServerGroupView } from 'ecloud/domain';
import { AmazonCloneServerGroupModal } from 'ecloud/serverGroup/configure/wizard/AmazonCloneServerGroupModal';
...
export class AmazonServerGroupActions extends React.Component<IAmazonServerGroupActionsProps> {
  ...
  private destroyServerGroup = (): void => {
    ...
    if (app.attributes.platformHealthOnlyShowOverride && app.attributes.platformHealthOnly) {
      confirmationModalParams.interestingHealthProviderNames = ['Ecloud'];
    }
  ...
  private rollbackServerGroup = (): void => {
    ...
    ModalInjector.modalService.open({
      ...
      controller: 'ecloudRollbackServerGroupCtrl as ctrl',
      resolve: {
  ...
  private cloneServerGroup = (): void => {
    const { app, serverGroup } = this.props;
    AwsReactInjector.ecloudServerGroupCommandBuilder
