...
import { AwsModalFooter } from 'ecloud/common';
import { IAmazonAsg, IAmazonServerGroup } from 'ecloud/domain';
  ...
  constructor(props: IAmazonResizeServerGroupModalProps) {
    ...
    this.state = {
      ...
      interestingHealthProviderNames:
        attributes.platformHealthOnlyShowOverride && attributes.platformHealthOnly ? ['Ecloud'] : null,
    };
  }
