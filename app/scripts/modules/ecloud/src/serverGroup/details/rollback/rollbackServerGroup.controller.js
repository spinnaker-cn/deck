...
module.exports = angular
  .module('spinnaker.ecloud.serverGroup.details.rollback.controller', [SERVER_GROUP_WRITER])
  .controller('ecloudRollbackServerGroupCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'application',
    ...
    function(
      ...
      if (application && application.attributes) {
        if (application.attributes.platformHealthOnlyShowOverride && application.attributes.platformHealthOnly) {
          $scope.command.interestingHealthProviderNames = ['Ecloud'];
        }
