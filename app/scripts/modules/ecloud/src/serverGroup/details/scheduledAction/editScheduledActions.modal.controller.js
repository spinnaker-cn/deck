...
module.exports = angular
  .module('spinnaker.ecloud.serverGroup.details.scheduledActions.editScheduledActions.modal.controller', [])
  .controller('ecloudEditScheduledActionsCtrl', [
    '$scope',
    '$uibModalInstance',
    'application',
    'serverGroup',
    function($scope, $uibModalInstance, application, serverGroup) {
      ...
      this.submit = () => {
        var job = $scope.command.scheduledActions.map(sa => ({
          type: 'upsertEcloudScheduledActions',
