...
import { ITargetTrackingConfiguration, ITargetTrackingPolicy } from 'ecloud/domain';
import { IUpsertScalingPolicyCommand, ScalingPolicyWriter } from 'ecloud/serverGroup';
