...
import { ITargetTrackingConfiguration, ITargetTrackingPolicy } from 'ecloud/domain/ITargetTrackingPolicy';
...
export const TARGET_TRACKING_SUMMARY_COMPONENT = 'spinnaker.ecloud.scalingPolicy.targetTracking.summary.component';
