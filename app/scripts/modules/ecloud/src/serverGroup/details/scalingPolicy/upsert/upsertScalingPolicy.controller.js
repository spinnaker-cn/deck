...
module.exports = angular
  .module('spinnaker.ecloud.serverGroup.details.scalingPolicy.upsertScalingPolicy.controller', [
    ...
    function($uibModalInstance, serverGroup, application, policy) {
      ...
      function createCommand() {
        return {
          ...
          minAdjustmentValue: policy.minAdjustmentValue,
        };
      }
      ...
      let prepareCommandForSubmit = () => {
        ...
        return {
          ...
          minAdjustmentValue: command.minAdjustmentValue,
