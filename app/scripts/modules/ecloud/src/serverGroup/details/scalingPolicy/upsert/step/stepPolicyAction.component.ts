...
export const STEP_POLICY_ACTION = 'spinnaker.ecloud.scalingPolicy.stepPolicy.action';
module(STEP_POLICY_ACTION, []).component('ecloudStepPolicyAction', stepPolicyActionComponent);
