...
import { IConfigurableMetric } from 'ecloud/serverGroup';
...
export const METRIC_SELECTOR_COMPONENT = 'spinnaker.ecloud.scalingPolicy.alarm.metric.editor';
module(METRIC_SELECTOR_COMPONENT, []).component('ecloudMetricSelector', component);
