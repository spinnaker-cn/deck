...
import { IAmazonNetworkLoadBalancer, IAmazonNetworkLoadBalancerUpsertCommand } from 'ecloud/domain';
...
> {
  ...
  constructor(props: ICreateNetworkLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.loadBalancer
      ? AwsReactInjector.ecloudLoadBalancerTransformer.convertNetworkLoadBalancerForEditing(props.loadBalancer)
      : AwsReactInjector.ecloudLoadBalancerTransformer.constructNewNetworkLoadBalancerTemplate(props.app);
