...
import { IAmazonClassicLoadBalancer, IAmazonClassicLoadBalancerUpsertCommand } from 'ecloud/domain';
...
> {
  ...
  constructor(props: ICreateClassicLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.loadBalancer
      ? AwsReactInjector.ecloudLoadBalancerTransformer.convertClassicLoadBalancerForEditing(props.loadBalancer)
      : AwsReactInjector.ecloudLoadBalancerTransformer.constructNewClassicLoadBalancerTemplate(props.app);
