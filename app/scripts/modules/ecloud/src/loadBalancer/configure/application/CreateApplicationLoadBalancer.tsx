...
import { IAmazonApplicationLoadBalancer, IAmazonApplicationLoadBalancerUpsertCommand } from 'ecloud/domain';
...
> {
  ...
  constructor(props: ICreateApplicationLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.command
      ...
      : props.loadBalancer
      ? AwsReactInjector.ecloudLoadBalancerTransformer.convertApplicationLoadBalancerForEditing(props.loadBalancer)
      : AwsReactInjector.ecloudLoadBalancerTransformer.constructNewApplicationLoadBalancerTemplate(props.app);
        ...
        render={({ formik, nextIdx, wizard }) => {
          ...
          return (
            <>
              ...
              { !isInternalLoadBalancer && <WizardPage
