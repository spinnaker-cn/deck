...
import { AWSProviderSettings } from 'ecloud/aws.settings';
import { IAmazonLoadBalancerUpsertCommand } from 'ecloud/domain';
  ...
  public componentDidMount(): void {
    ...
    const availableSecurityGroups$ = Observable.combineLatest(vpcId$, allSecurityGroups$)
      ...
      .map(([[vpcId, allSecurityGroups], formValues]) => {
        ...
        const forRegion = (forAccount.ecloud && forAccount.ecloud[formValues.region]) || [];
