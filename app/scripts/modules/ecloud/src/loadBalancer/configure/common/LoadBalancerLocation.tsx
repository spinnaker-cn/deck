...
import { IAmazonLoadBalancer, IAmazonLoadBalancerUpsertCommand } from 'ecloud/domain';
...
export class LoadBalancerLocation extends React.Component<ILoadBalancerLocationProps, ILoadBalancerLocationState>
  ...
  public componentDidMount(): void {
    ...
    const allAccounts$ = Observable.fromPromise(AccountService.listAccounts('ecloud')).shareReplay(1);
  ...
  private getAvailableSubnets(credentials: string, region: string): IPromise<ISubnet[]> {
    return SubnetReader.listSubnetsByProvider('ecloud').then(subnets => {
