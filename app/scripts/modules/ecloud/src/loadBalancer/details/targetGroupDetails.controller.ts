...
import { IAmazonApplicationLoadBalancer, ITargetGroup } from 'ecloud/domain/IAmazonLoadBalancer';
...
export const AWS_TARGET_GROUP_DETAILS_CTRL = 'spinnaker.ecloud.loadBalancer.details.targetGroupDetails.controller';
module(AWS_TARGET_GROUP_DETAILS_CTRL, [require('@uirouter/angularjs').default]).controller(
  'ecloudTargetGroupDetailsCtrl',
