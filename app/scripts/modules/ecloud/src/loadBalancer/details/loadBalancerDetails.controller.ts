...
export const AWS_LOAD_BALANCER_DETAILS_CTRL = 'spinnaker.ecloud.loadBalancer.details.controller';
module(AWS_LOAD_BALANCER_DETAILS_CTRL, [
  ...
  LOAD_BALANCER_READ_SERVICE,
  CONFIRMATION_MODAL_SERVICE,
]).controller('ecloudLoadBalancerDetailsCtrl', AwsLoadBalancerDetailsController);
