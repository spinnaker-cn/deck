...
import { IAuthenticateOidcActionConfig } from 'ecloud/loadBalancer/OidcConfigReader';

import { IAmazonServerGroup } from './IAmazonServerGroup';
import { IEcloudHealthCheck } from './IAmazonHealth';
...
export interface IListenerRule {
  ...
  url: string;
  locationId?: string;
  healthCheck?: IEcloudHealthCheck;
  default?: boolean;
