...
import { AMAZON_INSTANCE_WRITE_SERVICE } from 'ecloud/instance/amazon.instance.write.service';

module.exports = angular
  .module('spinnaker.ecloud.instance.details.controller', [
  ...
  .controller('ecloudInstanceDetailsCtrl', [
    '$scope',
    '$state',
    '$uibModal',
    ...
    function(
      ...
      $scope.detailsTemplateUrl = CloudProviderRegistry.getValue('ecloud', 'instance.detailsTemplateUrl');
      ...
      function extractHealthMetrics(instance, latest) {
        ...
        var displayableMetrics = instance.health.filter(function(metric) {
          return metric.type !== 'Ecloud' || metric.state !== 'Unknown';
        });
      ...
      this.rebootInstance = function rebootInstance() {
        ...
        var submitMethod = (params = {}) => {
          if (app.attributes && app.attributes.platformHealthOnlyShowOverride && app.attributes.platformHealthOnly) {
            params.interestingHealthProviderNames = ['Ecloud'];
          }
