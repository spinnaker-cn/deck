...
export const AWS_SECURITY_GROUP_READER = 'spinnaker.ecloud.securityGroup.reader';
module(AWS_SECURITY_GROUP_READER, []).service('ecloudSecurityGroupReader', AwsSecurityGroupReader);
