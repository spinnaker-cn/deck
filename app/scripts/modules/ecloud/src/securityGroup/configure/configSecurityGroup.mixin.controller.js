...
module.exports = angular
  .module('spinnaker.ecloud.securityGroup.baseConfig.controller', [
  ...
  .controller('ecloudConfigSecurityGroupMixin', [
    ...
    function($scope, $state, $uibModalInstance, application, securityGroup, securityGroupReader) {
      ...
      ctrl.initializeAccounts = () => {
        return AccountService.listAllAccounts('ecloud').then(function(accounts) {
      ...
      function configureFilteredSecurityGroups() {
        ...
        var regionalGroupNames = _.get(allSecurityGroups, [account, 'ecloud', region].join('.'), []).map(
          sg => sg.name,
        );
      ...
      ctrl.initializeSecurityGroups = function() {
        return securityGroupReader.getAllSecurityGroups().then(function(securityGroups) {
          ...
          var availableGroups;
          if (account && region) {
            availableGroups = (securityGroups[account] && securityGroups[account].ecloud[region]) || [];
          } else {
