...
import { scalingPolicyDetailsSummary } from 'ecloud/serverGroup/details/scalingPolicy/detailsSummary.component';
import { IScalingPolicySummaryProps } from 'ecloud/serverGroup/details/scalingPolicy/ScalingPolicySummary';
...
export class AwsNgReactInjector extends ReactInject {
  ...
  public ScalingPolicySummary: React.ComponentClass<IScalingPolicySummaryProps> = angular2react('ecloudScalingPolicySummary', scalingPolicyDetailsSummary, this.$injectorProxy) as any;
