...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@spinnaker/ecloud': path.join(__dirname, 'src'),
      ...
      ecloud: path.join(__dirname, 'src'),
    },
  },
  module: {
    rules: [
      ...
      },
      {
        ...
        exclude: exclusionPattern,
        use: [
          { loader: 'ngtemplate-loader?relativeTo=' + path.resolve(__dirname) + '&prefix=ecloud' },
          { loader: 'html-loader' },
        ],
      },
      {
