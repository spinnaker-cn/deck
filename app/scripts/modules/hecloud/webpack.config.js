...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@spinnaker/hecloud': path.join(__dirname, 'src'),
      ...
      hecloud: path.join(__dirname, 'src'),
    },
  },
  module: {
    rules: [
      ...
      },
      {
        ...
        exclude: exclusionPattern,
        use: [
          { loader: 'ngtemplate-loader?relativeTo=' + path.resolve(__dirname) + '&prefix=hecloud' },
          { loader: 'html-loader' },
        ],
      },
      {
