...
export interface IHeModalFooterProps {
  account: string;
  isValid?: boolean;
  onCancel: () => void;
  onSubmit: () => void;
...
export interface IHeModalFooterState {
  verified: boolean;
  requireVerification: boolean;
}

export class HeModalFooter extends React.Component<IHeModalFooterProps, IHeModalFooterState> {
  public static defaultProps: Partial<IHeModalFooterProps> = {
    isValid: true,
  };
