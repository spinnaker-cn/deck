...
module.exports = angular
  .module('spinnaker.hecloud.serverGroup.details.securityGroup.editSecurityGroups.modal.controller', [
    SERVER_GROUP_WRITER,
    SECURITY_GROUP_READER,
  ])
  .controller('hecloudEditSecurityGroupsCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'securityGroupReader',
    ...
    function(
      ...
      securityGroupReader.getAllSecurityGroups().then(allGroups => {
        ...
        this.availableSecurityGroups = _.get(allGroups, [account, 'hecloud', region].join('.'), [])
