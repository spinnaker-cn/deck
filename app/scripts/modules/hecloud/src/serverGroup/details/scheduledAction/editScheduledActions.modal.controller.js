...
module.exports = angular
  .module('spinnaker.hecloud.serverGroup.details.scheduledActions.editScheduledActions.modal.controller', [])
  .controller('hecloudEditScheduledActionsCtrl', [
    '$scope',
    '$uibModalInstance',
    'application',
    'serverGroup',
    function($scope, $uibModalInstance, application, serverGroup) {
      ...
      this.submit = () => {
        var job = $scope.command.scheduledActions.map(sa => ({
          type: 'upsertHeCloudScheduledActions',
