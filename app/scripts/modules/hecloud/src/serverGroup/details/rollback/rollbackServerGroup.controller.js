...
module.exports = angular
  .module('spinnaker.hecloud.serverGroup.details.rollback.controller', [SERVER_GROUP_WRITER])
  .controller('hecloudRollbackServerGroupCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'application',
    ...
    function(
      ...
      if (application && application.attributes) {
        if (application.attributes.platformHealthOnlyShowOverride && application.attributes.platformHealthOnly) {
          $scope.command.interestingHealthProviderNames = ['HeCloud'];
        }
