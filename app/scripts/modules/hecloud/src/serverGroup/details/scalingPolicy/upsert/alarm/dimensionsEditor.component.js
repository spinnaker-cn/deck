...
module.exports = angular
  .module('spinnaker.hecloud.serverGroup.details.scalingPolicy.dimensionEditor', [])
    ...
    controller: function() {
      ...
      this.fetchDimensionOptions = () => {
        ...
        return Observable.fromPromise(
          CloudMetricsReader.listMetrics('hecloud', this.serverGroup.account, this.serverGroup.region, filters),
        );
      };
