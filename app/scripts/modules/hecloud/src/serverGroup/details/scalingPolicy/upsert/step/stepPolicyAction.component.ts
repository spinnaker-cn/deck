...
export const STEP_POLICY_ACTION = 'spinnaker.hecloud.scalingPolicy.stepPolicy.action';
module(STEP_POLICY_ACTION, []).component('hecloudStepPolicyAction', stepPolicyActionComponent);
