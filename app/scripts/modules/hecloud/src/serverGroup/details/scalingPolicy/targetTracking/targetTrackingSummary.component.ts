...
import { ITargetTrackingConfiguration, ITargetTrackingPolicy } from 'hecloud/domain/ITargetTrackingPolicy';
...
export const TARGET_TRACKING_SUMMARY_COMPONENT = 'spinnaker.hecloud.scalingPolicy.targetTracking.summary.component';
