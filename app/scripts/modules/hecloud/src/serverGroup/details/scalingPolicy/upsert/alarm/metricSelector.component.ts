...
import { IConfigurableMetric } from 'hecloud/serverGroup';
...
export class MetricSelectorController implements IController {
  ...
  public namespaces = get(HeProviderSettings, 'metrics.customNamespaces', []).concat(NAMESPACES);
      ...
      <div style="display: inline-block; width: 500px" ng-if="$ctrl.state.metricsLoaded">
        ...
        <div style="padding-left: 5px;">
          <a href class="small"
            ...
            Only show metrics for this auto scaling group <help-field key="hecloud.scalingPolicy.search.restricted"></help-field>
          </a>
        </div>
      </div>`,
};

export const METRIC_SELECTOR_COMPONENT = 'spinnaker.hecloud.scalingPolicy.alarm.metric.editor';
module(METRIC_SELECTOR_COMPONENT, []).component('hecloudMetricSelector', component);
