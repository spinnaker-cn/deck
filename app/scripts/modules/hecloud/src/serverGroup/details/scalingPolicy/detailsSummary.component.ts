...
export const DETAILS_SUMMARY = 'spinnaker.hecloud.scalingPolicy.details.summary.component';
module(DETAILS_SUMMARY, []).component('hecloudScalingPolicySummary', scalingPolicyDetailsSummary);
