...
import { IScalingProcess } from 'hecloud/domain';
...
> {
  ...
  private toggleScalingProcesses = (): void => {
    ModalInjector.modalService.open({
      ...
      controller: 'hecloudModifyScalingProcessesCtrl as ctrl',
      resolve: {
  ...
  private getState(props: IHeCloudServerGroupDetailsSectionProps): IScalingProcessesDetailsSectionState {
