...
import { VpcTag } from 'hecloud/vpc/VpcTag';

import { IHeCloudServerGroupDetailsSectionProps } from './IHeCloudServerGroupDetailsSectionProps';

export interface IHeCloudInfoDetailsSectionState {
  changeConfig: IViewChangesConfig;
}

export class HeCloudInfoDetailsSection extends React.Component<
  IHeCloudServerGroupDetailsSectionProps,
  IHeCloudInfoDetailsSectionState
> {
  ...
  private getChangeConfig(serverGroup: IHeCloudServerGroupView): IViewChangesConfig {
  ...
  public componentWillReceiveProps(nextProps: IHeCloudServerGroupDetailsSectionProps) {
