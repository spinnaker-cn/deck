import { IHeCloudServerGroup, IScalingProcess } from 'hecloud/domain';

export class AutoScalingProcessService {
  public static getDisabledDate(serverGroup: IHeCloudServerGroup): number {
  ...
  public static normalizeScalingProcesses(serverGroup: IHeCloudServerGroup): IScalingProcess[] {
