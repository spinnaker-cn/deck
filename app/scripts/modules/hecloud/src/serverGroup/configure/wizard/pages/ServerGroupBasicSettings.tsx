...
import { IHeCloudImage } from '../../../../image';
import { SubnetSelectField } from 'tencent/subnet';

import { HeCloudImageSelectInput } from '../../HeCloudImageSelectInput';
...
export class ServerGroupBasicSettings
  ...
  constructor(props: IServerGroupBasicSettingsProps) {
    ...
    const selectedImage = HeCloudImageSelectInput.makeFakeImage(amiName, imageId, region);
  ...
  private imageChanged = (image: IHeCloudImage) => {
  ...
  public validate(values: IHeCloudServerGroupCommand): { [key: string]: string } {
  ...
  private strategyChanged = (values: IHeCloudServerGroupCommand, strategy: any) => {
      ...
      <div className="container-fluid form-horizontal">
        ...
        <div className="form-group">
          <div className="col-md-3 sm-label-right">
            Stack <HelpField id="hecloud.serverGroup.stack" />
          </div>
          <div className="col-md-7">
            <input
              type="text"
        ...
        <div className="form-group">
          <div className="col-md-3 sm-label-right">
            Detail <HelpField id="hecloud.serverGroup.detail" />
          </div>
          <div className="col-md-7">
            <input
              type="text"
        ...
        {!values.viewState.disableImageSelection && (
          <div className="form-group">
            <div className="col-md-3 sm-label-right">
              Image <HelpField id="hecloud.serverGroup.imageName" />
            </div>
            {isExpressionLanguage(values.amiName) ? (
              <Field name="amiName" />
            ) : (
              <HeCloudImageSelectInput
