...
import {
  ...
  IHeCloudDisk,
} from 'hecloud/serverGroup/configure/serverGroupConfiguration.service';
...
export class ServerGroupAdvancedSettingsCommon extends React.Component<IServerGroupAdvancedSettingsProps> {
  ...
  private dataDiskTypeChange = (dataDisk: IHeCloudDisk, value: string) => {
    dataDisk.diskType = value;
    this.updateDataDisks();
  };

  private dataDiskSizeChange = (dataDisk: IHeCloudDisk, value: number) => {
    dataDisk.diskSize = value;
    this.updateDataDisks();
  };

  private dataDiskSnapshotIdChange = (dataDisk: IHeCloudDisk, value: string) => {
      ...
      <div className="container-fluid form-horizontal">
        ...
        <div className="form-group">
          <div className="col-md-5 sm-label-right">
            ...
            <HelpField id="hecloud.serverGroup.base64UserData" />
          </div>
          <div className="col-md-6">
        ...
        <div className="form-group">
          <div className="col-md-5 sm-label-right">
            <b>Agency (optional) </b>
            <HelpField id="hecloud.serverGroup.agency" />
          </div>
          <div className="col-md-6">
        ...
        <div className="form-group">
          <div className="sm-label-left">
            <b>Tags (optional)</b>
            <HelpField id="hecloud.serverGroup.tags" />
          </div>
