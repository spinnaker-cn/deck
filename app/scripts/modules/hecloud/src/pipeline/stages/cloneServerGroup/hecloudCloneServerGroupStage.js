...
module.exports = angular
  .module('spinnaker.hecloud.pipeline.stage.cloneServerGroupStage', [])
  .config(function() {
  ...
  .controller('hecloudCloneServerGroupStageCtrl', [
    '$scope',
    function($scope) {
      ...
      AccountService.listAccounts('hecloud').then(accounts => {
      ...
      stage.cloudProviderType = 'hecloud';
      ...
      if (stage.isNew) {
        stage.useAmiBlockDeviceMappings = _.get(
          $scope,
          'application.attributes.providerSettings.hecloud.useAmiBlockDeviceMappings',
          false,
        );
