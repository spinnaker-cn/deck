...
import { HeCloudLoadBalancerDataUtils } from 'hecloud/loadBalancer/hecloudLoadBalancerDataUtils';
import { IHeCloudServerGroup, ITargetGroup } from 'hecloud/domain';
...
export interface IHeCloudLoadBalancersTagState {
  loadBalancers: ILoadBalancer[];
  targetGroups: ITargetGroup[];
  isLoading: boolean;
}

export class HeCloudLoadBalancersTag extends React.Component<ILoadBalancersTagProps, IHeCloudLoadBalancersTagState> {
  ...
  public componentDidMount(): void {
    ...
    HeCloudLoadBalancerDataUtils.populateTargetGroups(this.props.application, this.props
      .serverGroup as IHeCloudServerGroup).then((targetGroups: ITargetGroup[]) => {
      if (this.mounted) {
  ...
  public render(): React.ReactElement<HeCloudLoadBalancersTag> {
