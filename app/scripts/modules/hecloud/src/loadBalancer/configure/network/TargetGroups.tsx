...
import { IHeCloudApplicationLoadBalancer, IHeCloudNetworkLoadBalancerUpsertCommand } from 'hecloud/domain';
...
export class TargetGroups extends React.Component<ITargetGroupsProps, ITargetGroupsState>
  implements IWizardPageComponent<IHeCloudNetworkLoadBalancerUpsertCommand> {
  ...
  public validate(
    values: IHeCloudNetworkLoadBalancerUpsertCommand,
  ): FormikErrors<IHeCloudNetworkLoadBalancerUpsertCommand> {
    const errors = {} as any;
