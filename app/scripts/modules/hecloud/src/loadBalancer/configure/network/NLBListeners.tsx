...
import { NLBListenerProtocol, IListenerDescription, IHeCloudNetworkLoadBalancerUpsertCommand } from 'hecloud/domain';
...
export class NLBListeners extends React.Component<INLBListenersProps>
  ...
  public validate(values: IHeCloudNetworkLoadBalancerUpsertCommand) {
    const errors = {} as any;
