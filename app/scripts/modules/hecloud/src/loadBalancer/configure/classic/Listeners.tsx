...
import { HeCloudCertificateReader } from 'hecloud/certificates/HeCloudCertificateReader';
import { HeCloudCertificateSelectField } from '../common/HeCloudCertificateSelectField';

import './Listeners.less';

export interface IListenersProps {
  formik: FormikProps<IHeCloudClassicLoadBalancerUpsertCommand>;
  app: Application;
}

export interface IListenersState {
  certificates: { [accountId: number]: IHeCloudCertificate[] };
}
...
export class Listeners extends React.Component<IListenersProps, IListenersState> {
  ...
  private loadCertificates(): void {
    HeCloudCertificateReader.listCertificates().then(certificates => {
