...
export interface IHeCloudCertificateSelectFieldProps {
  certificates: { [accountName: string]: IHeCloudCertificate[] };
  accountName: string;
  currentValue: string;
...
@Overridable('hecloud.certificateSelectField')
export class HeCloudCertificateSelectField extends React.Component<IHeCloudCertificateSelectFieldProps> {
  public render() {
