            ...
            <tr className="listener-rule">
              ...
              <td colSpan={2}>
                <div className="listener-rule-condition col-md-6">
                  <label>Host</label>
                  {/* <HelpField id="huaweicloud.loadBalancer.ruleCondition.host" /> */}
                  <input
                ...
                <div className="listener-rule-condition col-md-6">
                  <label>Path</label>
                  {/* <HelpField id="huaweicloud.loadBalancer.ruleCondition.path" /> */}
                  <input
                    disabled={!props.isNewListener}
                    className="form-control input-sm"
                    type="text"
...
const HealthCheck = ({ healthCheck, isL7, handleHealthCheckChanged, isNewListener }: IHealthCheckProps) => {
  return (
    <div>
      <div className="wizard-pod-row">
            ...
            {!!healthCheck.healthSwitch && healthCheck.showAdvancedSetting && (
              <span className="wizard-pod-content">
                ...
                <input
                  ...
                  min={1}
                  max={10}
                  value={healthCheck.maxRetries || ''}
                  onChange={event =>
                    handleHealthCheckChanged(healthCheck, 'maxRetries', parseInt(event.target.value, 10))
                  }
                  required={true}
                />
              </span>
