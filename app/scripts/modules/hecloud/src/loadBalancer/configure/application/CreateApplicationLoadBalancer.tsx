...
import { IHeCloudApplicationLoadBalancer, IHeCloudApplicationLoadBalancerUpsertCommand } from 'hecloud/domain';
...
export interface ICreateApplicationLoadBalancerState {
  ...
  isNew: boolean;
  loadBalancerCommand: IHeCloudApplicationLoadBalancerUpsertCommand;
...
> {
  ...
  ): Promise<IHeCloudApplicationLoadBalancerUpsertCommand> {
  ...
  constructor(props: ICreateApplicationLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.command
      ? (props.command as IHeCloudApplicationLoadBalancerUpsertCommand) // ejecting from a wizard
      : props.loadBalancer
      ? HeReactInjector.hecloudLoadBalancerTransformer.convertApplicationLoadBalancerForEditing(props.loadBalancer)
      : HeReactInjector.hecloudLoadBalancerTransformer.constructNewApplicationLoadBalancerTemplate(props.app);
  ...
  private formatListeners(command: IHeCloudApplicationLoadBalancerUpsertCommand): void {
  ...
  private formatCommand(base: IHeCloudApplicationLoadBalancerUpsertCommand): any {
  ...
  protected onApplicationRefresh(values: IHeCloudApplicationLoadBalancerUpsertCommand): void {
  ...
  private onTaskComplete(values: IHeCloudApplicationLoadBalancerUpsertCommand): void {
  ...
  private submit = (values: IHeCloudApplicationLoadBalancerUpsertCommand): void => {
  ...
  public render() {
    ...
    return (
      <WizardModal<IHeCloudApplicationLoadBalancerUpsertCommand>
        heading={heading}
