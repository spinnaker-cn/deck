...
import { IRedirectActionConfig } from 'hecloud/domain';
        ...
        <Formik<IRedirectActionConfig>
          ...
          render={({ isValid }) => (
            <Form className="form-horizontal">
              ...
              <Modal.Header>
                <h3>
                  Configure Redirect <HelpField id="hecloud.loadBalancer.redirect" />
                </h3>
              </Modal.Header>
              ...
              <Modal.Body>
                <FormikFormField
                  ...
                  help={<HelpField id="hecloud.loadBalancer.redirect.host" />}
                />
                <FormikFormField
                  name="path"
                  label="Path"
                  required={false}
                  input={props => <TextInput {...props} />}
                  help={<HelpField id="hecloud.loadBalancer.redirect.path" />}
                />
                <FormikFormField
                  name="port"
                  label="Port"
                  required={false}
                  input={props => <TextInput {...props} />}
                  help={<HelpField id="hecloud.loadBalancer.redirect.port" />}
                />
                <FormikFormField
                  name="protocol"
                  label="Protocol"
                  ...
                  help={<HelpField id="hecloud.loadBalancer.redirect.protocol" />}
                />
                <FormikFormField
                  name="query"
                  label="Query"
                  required={false}
                  input={props => <TextInput {...props} />}
                  help={<HelpField id="hecloud.loadBalancer.redirect.query" />}
                />
                <FormikFormField
                  name="statusCode"
                  label="Status Code"
                  ...
                  help={<HelpField id="hecloud.loadBalancer.redirect.statusCode" />}
                />
              </Modal.Body>
