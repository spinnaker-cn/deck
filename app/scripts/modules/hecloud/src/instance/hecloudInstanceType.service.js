...
module.exports = angular.module('spinnaker.hecloud.instanceType.service', []).factory('hecloudInstanceTypeService', [
  '$http',
  '$q',
  function($http, $q) {
    var m5 = {
    ...
    var r5 = {
      type: 'r5',
      description:
        'r5 instances are optimized for memory-intensive applications and have the lowest cost per GiB of RAM among HeCloud EC2 instance types.',
      instanceTypes: [
        {
          name: 'r5.large',
          label: 'Large',
