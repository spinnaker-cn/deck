...
module.exports = angular
  .module('spinnaker.huaweicloud.securityGroup.details.controller', [
    require('@uirouter/angularjs').default,
    SECURITY_GROUP_READER,
    CONFIRMATION_MODAL_SERVICE,
    require('../clone/cloneSecurityGroup.controller').name,
  ])
  .controller('huaweicloudSecurityGroupDetailsCtrl', [
    '$scope',
    '$state',
    ...
    function($scope, $state, resolvedSecurityGroup, app, confirmationModalService, securityGroupReader, $uibModal) {
      ...
      $scope.detailsTemplateUrl = CloudProviderRegistry.getValue('huaweicloud', 'securityGroup.detailsTemplateUrl');
      ...
      this.editInboundRules = function editInboundRules() {
        $uibModal.open({
          ...
          controller: 'huaweicloudEditSecurityGroupCtrl as ctrl',
          size: 'lg',
          resolve: {
      ...
      this.cloneSecurityGroup = function cloneSecurityGroup() {
        $uibModal.open({
          ...
          controller: 'huaweicloudCloneSecurityGroupController as ctrl',
          size: 'lg',
          resolve: {
            securityGroup: function() {
