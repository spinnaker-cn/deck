...
export interface IHuaweiModalFooterProps {
  account: string;
  isValid?: boolean;
  onCancel: () => void;
  onSubmit: () => void;
...
export interface IHuaweiModalFooterState {
  verified: boolean;
  requireVerification: boolean;
}

export class HuaweiModalFooter extends React.Component<IHuaweiModalFooterProps, IHuaweiModalFooterState> {
  public static defaultProps: Partial<IHuaweiModalFooterProps> = {
    isValid: true,
  };
