...
import {
  ...
  IScalingPolicy,
  IHuaweiCloudServerGroupView,
} from '../domain';
import { VpcReader } from '../vpc/VpcReader';

export class HuaweiServerGroupTransformer {
  ...
  public normalizeServerGroupDetails(serverGroup: IHuaweiCloudServerGroup): IHuaweiCloudServerGroupView {
    const view: IHuaweiCloudServerGroupView = { ...serverGroup } as IHuaweiCloudServerGroupView;
  ...
  public normalizeServerGroup(serverGroup: IHuaweiCloudServerGroup): IPromise<IHuaweiCloudServerGroup> {
  ...
  private addVpcNameToServerGroup(serverGroup: IHuaweiCloudServerGroup): (vpc: IVpc[]) => IHuaweiCloudServerGroup {
    return (vpcs: IVpc[]) => {
...
export const AWS_SERVER_GROUP_TRANSFORMER = 'spinnaker.huaweicloud.serverGroup.transformer';
module(AWS_SERVER_GROUP_TRANSFORMER, []).service('huaweicloudServerGroupTransformer', HuaweiServerGroupTransformer);
