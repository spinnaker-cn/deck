...
export const STEP_POLICY_ACTION = 'spinnaker.huaweicloud.scalingPolicy.stepPolicy.action';
module(STEP_POLICY_ACTION, []).component('huaweicloudStepPolicyAction', stepPolicyActionComponent);
