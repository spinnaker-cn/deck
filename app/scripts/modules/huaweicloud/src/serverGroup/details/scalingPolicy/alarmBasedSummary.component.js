...
module.exports = angular
  .module('spinnaker.huaweicloud.serverGroup.details.scalingPolicy.alarmBasedSummary.component', [
    require('./upsert/upsertScalingPolicy.controller').name,
    SCALING_POLICY_POPOVER,
    CONFIRMATION_MODAL_SERVICE,
  ])
  .component('huaweicloudAlarmBasedSummary', {
    bindings: {
      policy: '=',
      serverGroup: '=',
      application: '=',
      ...
      function($uibModal, confirmationModalService) {
        ...
        this.editPolicy = () => {
          $uibModal.open({
            ...
            controller: 'huaweicloudUpsertScalingPolicyCtrl',
            controllerAs: 'ctrl',
            size: 'lg',
            resolve: {
              policy: () => this.policy,
