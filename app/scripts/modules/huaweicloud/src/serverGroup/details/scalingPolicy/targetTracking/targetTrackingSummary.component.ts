...
import { ITargetTrackingConfiguration, ITargetTrackingPolicy } from 'huaweicloud/domain/ITargetTrackingPolicy';
...
export const TARGET_TRACKING_SUMMARY_COMPONENT = 'spinnaker.huaweicloud.scalingPolicy.targetTracking.summary.component';
