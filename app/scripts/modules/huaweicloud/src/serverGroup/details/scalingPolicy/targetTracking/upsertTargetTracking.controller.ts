...
import { ITargetTrackingConfiguration, ITargetTrackingPolicy } from 'huaweicloud/domain';
import { IUpsertScalingPolicyCommand, ScalingPolicyWriter } from 'huaweicloud/serverGroup';
