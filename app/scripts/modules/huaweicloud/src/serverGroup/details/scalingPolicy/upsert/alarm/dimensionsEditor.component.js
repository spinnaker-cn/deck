...
module.exports = angular
  .module('spinnaker.huaweicloud.serverGroup.details.scalingPolicy.dimensionEditor', [])
    ...
    controller: function() {
      ...
      this.fetchDimensionOptions = () => {
        ...
        return Observable.fromPromise(
          CloudMetricsReader.listMetrics('huaweicloud', this.serverGroup.account, this.serverGroup.region, filters),
        );
      };
