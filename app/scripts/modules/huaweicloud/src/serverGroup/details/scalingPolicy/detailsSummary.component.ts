...
export const DETAILS_SUMMARY = 'spinnaker.huaweicloud.scalingPolicy.details.summary.component';
module(DETAILS_SUMMARY, []).component('huaweicloudScalingPolicySummary', scalingPolicyDetailsSummary);
