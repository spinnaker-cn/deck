import { IHuaweiCloudServerGroup, IScalingProcess } from 'huaweicloud/domain';

export class AutoScalingProcessService {
  public static getDisabledDate(serverGroup: IHuaweiCloudServerGroup): number {
  ...
  public static normalizeScalingProcesses(serverGroup: IHuaweiCloudServerGroup): IScalingProcess[] {
