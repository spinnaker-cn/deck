...
module.exports = angular
  .module('spinnaker.huaweicloud.serverGroup.details.securityGroup.editSecurityGroups.modal.controller', [
    SERVER_GROUP_WRITER,
    SECURITY_GROUP_READER,
  ])
  .controller('huaweicloudEditSecurityGroupsCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'securityGroupReader',
    ...
    function(
      ...
      securityGroupReader.getAllSecurityGroups().then(allGroups => {
        ...
        this.availableSecurityGroups = _.get(allGroups, [account, 'huaweicloud', region].join('.'), [])
