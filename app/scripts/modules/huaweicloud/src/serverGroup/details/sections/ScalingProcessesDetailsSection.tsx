...
import { IScalingProcess } from 'huaweicloud/domain';
...
> {
  ...
  private toggleScalingProcesses = (): void => {
    ModalInjector.modalService.open({
      ...
      controller: 'huaweicloudModifyScalingProcessesCtrl as ctrl',
      resolve: {
  ...
  private getState(props: IHuaweiCloudServerGroupDetailsSectionProps): IScalingProcessesDetailsSectionState {
  ...
  public componentWillReceiveProps(nextProps: IHuaweiCloudServerGroupDetailsSectionProps): void {
