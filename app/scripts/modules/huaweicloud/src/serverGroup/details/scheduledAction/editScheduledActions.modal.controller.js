...
module.exports = angular
  .module('spinnaker.huaweicloud.serverGroup.details.scheduledActions.editScheduledActions.modal.controller', [])
  .controller('huaweicloudEditScheduledActionsCtrl', [
    '$scope',
    '$uibModalInstance',
    'application',
    'serverGroup',
    function($scope, $uibModalInstance, application, serverGroup) {
      ...
      this.submit = () => {
        var job = $scope.command.scheduledActions.map(sa => ({
          type: 'upsertHuaweiCloudScheduledActions',
