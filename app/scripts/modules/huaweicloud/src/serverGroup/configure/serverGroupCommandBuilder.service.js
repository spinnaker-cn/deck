...
import { HuaweiProviderSettings } from '../../huaweicloud.settings';
import { AWS_SERVER_GROUP_CONFIGURATION_SERVICE } from 'huaweicloud/serverGroup/configure/serverGroupConfiguration.service';

module.exports = angular
  .module('spinnaker.huaweicloud.serverGroupCommandBuilder.service', [
  ...
  .factory('huaweicloudServerGroupCommandBuilder', [
    ...
    function($q, instanceTypeService, huaweicloudServerGroupConfigurationService) {
      function buildNewServerGroupCommand(application, defaults) {
        defaults = defaults || {};
        var credentialsLoader = AccountService.getCredentialsKeyedByAccount('huaweicloud');

        var defaultCredentials =
          defaults.account || application.defaultCredentials.huaweicloud || HuaweiProviderSettings.defaults.account;
        var defaultRegion =
          defaults.region || application.defaultRegions.huaweicloud || HuaweiProviderSettings.defaults.region;
        ...
        return $q
          ...
          .then(function(asyncData) {
            ...
            var applicationHuaweiSettings = _.get(application, 'attributes.providerSettings.huaweicloud', {});

            var useAmiBlockDeviceMappings = applicationHuaweiSettings.useAmiBlockDeviceMappings || false;
            ...
            if (
              ...
              command.interestingHealthProviderNames = ['HuaweiCloud'];
            }
      ...
      function buildUpdateServerGroupCommand(serverGroup) {
        ...
        huaweicloudServerGroupConfigurationService.configureUpdateCommand(command);
        return command;
      }

      function buildServerGroupCommandFromExisting(application, serverGroup, mode = 'clone') {
        var preferredZonesLoader = AccountService.getPreferredZonesByAccount('huaweicloud');
        ...
        var instanceTypeCategoryLoader = instanceTypeService.getCategoryForInstanceType('huaweicloud', instanceType);
