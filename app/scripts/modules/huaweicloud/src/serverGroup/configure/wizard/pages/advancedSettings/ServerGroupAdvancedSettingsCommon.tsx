...
import {
  ...
  IHuaweiCloudDisk,
} from 'huaweicloud/serverGroup/configure/serverGroupConfiguration.service';
...
export class ServerGroupAdvancedSettingsCommon extends React.Component<IServerGroupAdvancedSettingsProps> {
  ...
  private dataDiskTypeChange = (dataDisk: IHuaweiCloudDisk, value: string) => {
    dataDisk.diskType = value;
    this.updateDataDisks();
  };

  private dataDiskSizeChange = (dataDisk: IHuaweiCloudDisk, value: number) => {
    dataDisk.diskSize = value;
    this.updateDataDisks();
  };

  private dataDiskSnapshotIdChange = (dataDisk: IHuaweiCloudDisk, value: string) => {
      ...
      <div className="container-fluid form-horizontal">
        ...
        <div className="form-group">
          ...
          <div className="col-md-6">
            <Select
              ...
              clearable={false}
              options={keyPairs.map(t => ({ label: `${t.keyName}`, value: t.keyName }))}
        ...
        <div className="form-group">
          <div className="col-md-5 sm-label-right">
            ...
            <HelpField id="huaweicloud.serverGroup.base64UserData" />
          </div>
          <div className="col-md-6">
        ...
        <div className="form-group">
          <div className="sm-label-left">
            <b>Tags (optional)</b>
            <HelpField id="huaweicloud.serverGroup.tags" />
          </div>
