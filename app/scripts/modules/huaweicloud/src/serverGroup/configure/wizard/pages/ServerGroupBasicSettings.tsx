...
import { IHuaweiCloudImage } from '../../../../image';
import { SubnetSelectField } from 'tencent/subnet';

import { HuaweiCloudImageSelectInput } from '../../HuaweiCloudImageSelectInput';
...
export interface IServerGroupBasicSettingsState {
  selectedImage: IHuaweiCloudImage;
  namePreview: string;
...
export class ServerGroupBasicSettings
  ...
  constructor(props: IServerGroupBasicSettingsProps) {
    ...
    const selectedImage = HuaweiCloudImageSelectInput.makeFakeImage(amiName, imageId, region);
  ...
  private imageChanged = (image: IHuaweiCloudImage) => {
  ...
  public validate(values: IHuaweiCloudServerGroupCommand): { [key: string]: string } {
  ...
  private strategyChanged = (values: IHuaweiCloudServerGroupCommand, strategy: any) => {
    ...
    return (
      <div className="container-fluid form-horizontal">
        ...
        <div className="form-group">
          ...
          <div className="col-md-7">
            {
              values.region ? <SelectInput
              inputClassName="form-control input-sm"
              value={values.vpcId}
              options={values.backingData.filtered.vpcList && values.backingData.filtered.vpcList.map(item => ({ label: `${item.name}(${item.id})`, value: item.id })) || []}
        ...
        <div className="form-group">
          <div className="col-md-3 sm-label-right">
            Stack <HelpField id="huaweicloud.serverGroup.stack" />
          </div>
          <div className="col-md-7">
            <input
              type="text"
        ...
        <div className="form-group">
          <div className="col-md-3 sm-label-right">
            Detail <HelpField id="huaweicloud.serverGroup.detail" />
          </div>
          <div className="col-md-7">
            <input
              type="text"
        ...
        {!values.viewState.disableImageSelection && (
          <div className="form-group">
            <div className="col-md-3 sm-label-right">
              Image <HelpField id="huaweicloud.serverGroup.imageName" />
            </div>
            {isExpressionLanguage(values.amiName) ? (
              <Field name="amiName" />
            ) : (
              <HuaweiCloudImageSelectInput
