...
import { AMAZON_INSTANCE_WRITE_SERVICE } from 'huaweicloud/instance/huaweicloud.instance.write.service';

module.exports = angular
  .module('spinnaker.huaweicloud.instance.details.controller', [
  ...
  .controller('huaweicloudInstanceDetailsCtrl', [
    '$scope',
    '$state',
    '$uibModal',
    ...
    function(
      ...
      $scope.detailsTemplateUrl = CloudProviderRegistry.getValue('huaweicloud', 'instance.detailsTemplateUrl');
      ...
      function extractHealthMetrics(instance, latest) {
        ...
        var displayableMetrics = instance.health.filter(function(metric) {
          return metric.type !== 'HuaweiCloud' || metric.state !== 'Unknown';
        });
      ...
      this.terminateInstance = function terminateInstance() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.terminateInstance(instance, app, {
      ...
      this.terminateInstanceAndShrinkServerGroup = function terminateInstanceAndShrinkServerGroup() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.terminateInstanceAndShrinkServerGroup(instance, app, {
      ...
      this.rebootInstance = function rebootInstance() {
        ...
        var submitMethod = (params = {}) => {
          if (app.attributes && app.attributes.platformHealthOnlyShowOverride && app.attributes.platformHealthOnly) {
            params.interestingHealthProviderNames = ['HuaweiCloud'];
          }

          return huaweicloudInstanceWriter.rebootInstance(instance, app, params);
        };
      ...
      this.registerInstanceWithLoadBalancer = function registerInstanceWithLoadBalancer() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.registerInstanceWithLoadBalancer(instance, app);
        };
      ...
      this.deregisterInstanceFromLoadBalancer = function deregisterInstanceFromLoadBalancer() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.deregisterInstanceFromLoadBalancer(instance, app);
        };
      ...
      this.registerInstanceWithTargetGroup = function registerInstanceWithTargetGroup() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.registerInstanceWithTargetGroup(instance, app);
        };
      ...
      this.deregisterInstanceFromTargetGroup = function deregisterInstanceFromTargetGroup() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.deregisterInstanceFromTargetGroup(instance, app);
        };
      ...
      this.enableInstanceInDiscovery = function enableInstanceInDiscovery() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.enableInstanceInDiscovery(instance, app);
        };
      ...
      this.disableInstanceInDiscovery = function disableInstanceInDiscovery() {
        ...
        var submitMethod = function() {
          return huaweicloudInstanceWriter.disableInstanceInDiscovery(instance, app);
        };
