...
import { HuaweiCloudLoadBalancerDataUtils } from 'huaweicloud/loadBalancer/huaweicloudLoadBalancerDataUtils';
import { IHuaweiCloudServerGroup, ITargetGroup } from 'huaweicloud/domain';
...
export interface IHuaweiCloudLoadBalancersTagState {
  loadBalancers: ILoadBalancer[];
  targetGroups: ITargetGroup[];
  isLoading: boolean;
}

export class HuaweiCloudLoadBalancersTag extends React.Component<ILoadBalancersTagProps, IHuaweiCloudLoadBalancersTagState> {
  ...
  public componentDidMount(): void {
    ...
    HuaweiCloudLoadBalancerDataUtils.populateTargetGroups(this.props.application, this.props
      .serverGroup as IHuaweiCloudServerGroup).then((targetGroups: ITargetGroup[]) => {
      if (this.mounted) {
  ...
  public render(): React.ReactElement<HuaweiCloudLoadBalancersTag> {
