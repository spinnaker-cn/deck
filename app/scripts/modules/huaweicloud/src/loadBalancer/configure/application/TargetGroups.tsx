...
export interface ITargetGroupsProps {
  app: Application;
  formik: FormikProps<IHuaweiCloudApplicationLoadBalancerUpsertCommand>;
  isNew: boolean;
...
export class TargetGroups extends React.Component<ITargetGroupsProps, ITargetGroupsState>
  implements IWizardPageComponent<IHuaweiCloudApplicationLoadBalancerUpsertCommand> {
  ...
  public validate(
    values: IHuaweiCloudApplicationLoadBalancerUpsertCommand,
  ): FormikErrors<IHuaweiCloudApplicationLoadBalancerUpsertCommand> {
    const errors = {} as any;
  ...
  protected updateLoadBalancerNames(props: ITargetGroupsProps): void {
    ...
    Observable.fromPromise(app.getDataSource('loadBalancers').refresh(true))
      ...
      .subscribe(() => {
        app.getDataSource('loadBalancers').data.forEach((lb: IHuaweiCloudApplicationLoadBalancer) => {
                  ...
                  <div>
                    ...
                    <div className="wizard-pod-row">
                      <div className="wizard-pod-row-title">
                        <HelpField id="huaweicloud.targetGroup.targetType" /> <span>Target Type&nbsp;</span>
                      </div>
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                      ...
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                          <span className="wizard-pod-content">
                            ...
                            <HelpField id="huaweicloud.targetGroup.protocol" />{' '}
                            <select
                          ...
                          <span className="wizard-pod-content">
                            <label>Port </label>
                            <HelpField id="huaweicloud.targetGroup.port" />{' '}
                            <input
                              className="form-control input-sm inline-number"
                    ...
                    <div className="wizard-pod-row">
                      ...
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                          ...
                          <span className="wizard-pod-content">
                            <label>Port </label>
                            <HelpField id="huaweicloud.targetGroup.attributes.healthCheckPort.trafficPort" />{' '}
                            <select
                              className="form-control input-sm inline-number"
                              style={{ width: '90px' }}
                      ...
                      <div className="wizard-pod-row-contents">
                        <div className="wizard-pod-row-data">
                          <span className="wizard-pod-content">
                            ...
                            <HelpField id="huaweicloud.targetGroup.attributes.deregistrationDelay" />{' '}
                            <input
                              className="form-control input-sm inline-number"
                              type="text"
                          ...
                          <span className="wizard-pod-content">
                            <label className="checkbox-inline" style={{ paddingTop: '2px' }}>
                              ...
                              />{' '}
                              <label>Sticky</label>
                              <HelpField id="huaweicloud.targetGroup.attributes.stickinessEnabled" />
                            </label>
                          </span>
                          {targetGroup.attributes.stickinessEnabled && (
                            <span className="wizard-pod-content">
                              <label>Duration </label>
                              <HelpField id="huaweicloud.targetGroup.attributes.stickinessDuration" />{' '}
                              <input
                                className="form-control input-sm inline-number"
