...
import { IRedirectActionConfig } from 'huaweicloud/domain';
        ...
        <Formik<IRedirectActionConfig>
          ...
          render={({ isValid }) => (
            <Form className="form-horizontal">
              ...
              <Modal.Header>
                <h3>
                  Configure Redirect <HelpField id="huaweicloud.loadBalancer.redirect" />
                </h3>
              </Modal.Header>
              ...
              <Modal.Body>
                <FormikFormField
                  ...
                  help={<HelpField id="huaweicloud.loadBalancer.redirect.host" />}
                />
                <FormikFormField
                  name="path"
                  label="Path"
                  required={false}
                  input={props => <TextInput {...props} />}
                  help={<HelpField id="huaweicloud.loadBalancer.redirect.path" />}
                />
                <FormikFormField
                  name="port"
                  label="Port"
                  required={false}
                  input={props => <TextInput {...props} />}
                  help={<HelpField id="huaweicloud.loadBalancer.redirect.port" />}
                />
                <FormikFormField
                  name="protocol"
                  label="Protocol"
                  ...
                  help={<HelpField id="huaweicloud.loadBalancer.redirect.protocol" />}
                />
                <FormikFormField
                  name="query"
                  label="Query"
                  required={false}
                  input={props => <TextInput {...props} />}
                  help={<HelpField id="huaweicloud.loadBalancer.redirect.query" />}
                />
                <FormikFormField
                  name="statusCode"
                  label="Status Code"
                  ...
                  help={<HelpField id="huaweicloud.loadBalancer.redirect.statusCode" />}
                />
              </Modal.Body>
