...
import { NLBListenerProtocol, IListenerDescription, IHuaweiCloudNetworkLoadBalancerUpsertCommand } from 'huaweicloud/domain';
...
export class NLBListeners extends React.Component<INLBListenersProps>
  ...
  public validate(values: IHuaweiCloudNetworkLoadBalancerUpsertCommand) {
    const errors = {} as any;
