...
import { IHuaweiCloudApplicationLoadBalancer, IHuaweiCloudNetworkLoadBalancerUpsertCommand } from 'huaweicloud/domain';

export interface ITargetGroupsProps {
  app: Application;
  formik: FormikProps<IHuaweiCloudNetworkLoadBalancerUpsertCommand>;
  isNew: boolean;
...
export class TargetGroups extends React.Component<ITargetGroupsProps, ITargetGroupsState>
  implements IWizardPageComponent<IHuaweiCloudNetworkLoadBalancerUpsertCommand> {
  ...
  public validate(
    values: IHuaweiCloudNetworkLoadBalancerUpsertCommand,
  ): FormikErrors<IHuaweiCloudNetworkLoadBalancerUpsertCommand> {
    const errors = {} as any;
