...
export interface IHuaweiCloudCertificateSelectFieldProps {
  certificates: { [accountName: string]: IHuaweiCloudCertificate[] };
  accountName: string;
  currentValue: string;
...
@Overridable('huaweicloud.certificateSelectField')
export class HuaweiCloudCertificateSelectField extends React.Component<IHuaweiCloudCertificateSelectFieldProps> {
  public render() {
