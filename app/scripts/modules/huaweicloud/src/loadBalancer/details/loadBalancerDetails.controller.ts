...
import {
  ...
  IHuaweiCloudLoadBalancerSourceData,
  IListenerAction,
  ITargetGroup,
...
export class HuaweiLoadBalancerDetailsController implements IController {
  ...
  public loadBalancer: IHuaweiCloudLoadBalancer;
  ...
  public extractLoadBalancer(): IPromise<void> {
    ...
    if (appLoadBalancer) {
      ...
      return detailsLoader.then(
        (details: IHuaweiCloudLoadBalancerSourceData[]) => {
...
export const AWS_LOAD_BALANCER_DETAILS_CTRL = 'spinnaker.huaweicloud.loadBalancer.details.controller';
module(AWS_LOAD_BALANCER_DETAILS_CTRL, [
  ...
  LOAD_BALANCER_READ_SERVICE,
  CONFIRMATION_MODAL_SERVICE,
]).controller('huaweicloudLoadBalancerDetailsCtrl', HuaweiLoadBalancerDetailsController);
