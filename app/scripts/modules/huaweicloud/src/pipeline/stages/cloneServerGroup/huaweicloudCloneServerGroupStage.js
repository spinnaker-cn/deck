...
module.exports = angular
  .module('spinnaker.huaweicloud.pipeline.stage.cloneServerGroupStage', [])
  .config(function() {
  ...
  .controller('huaweicloudCloneServerGroupStageCtrl', [
    '$scope',
    function($scope) {
      ...
      AccountService.listAccounts('huaweicloud').then(accounts => {
      ...
      stage.cloudProviderType = 'huaweicloud';
      ...
      if (stage.isNew) {
        stage.useAmiBlockDeviceMappings = _.get(
          $scope,
          'application.attributes.providerSettings.huaweicloud.useAmiBlockDeviceMappings',
          false,
        );
