...
module.exports = angular
  .module('spinnaker.huaweicloud.pipeline.stage.bakeStage', [require('./bakeExecutionDetails.controller').name])
  .config(function() {
  ...
  .controller('huaweicloudBakeStageCtrl', [
    '$scope',
    '$q',
    '$uibModal',
    function($scope, $q, $uibModal) {
      ...
      $scope.viewState = {
        ...
        minRootVolumeSize: HuaweiProviderSettings.minRootVolumeSize,
      };

      function initialize() {
        $q.all({
          regions: BakeryReader.getRegions('huaweicloud'),
          baseOsOptions: BakeryReader.getBaseOsOptions('huaweicloud'),
          ...
          if (!$scope.stage.regions.length && $scope.application.defaultRegions.huaweicloud) {
            $scope.stage.regions.push($scope.application.defaultRegions.huaweicloud);
          }
          if (!$scope.stage.regions.length && $scope.application.defaultRegions.huaweicloud) {
            $scope.stage.regions.push($scope.application.defaultRegions.huaweicloud);
          }
