...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@spinnaker/ctyun': path.join(__dirname, 'src'),
  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        exclude: exclusionPattern,
        use: [
          { loader: 'ngtemplate-loader?relativeTo=' + path.resolve(__dirname) + '&prefix=ctyun' },
          { loader: 'html-loader' },
        ],
      },
      {
