...
export const AWS_SECURITY_GROUP_READER = 'spinnaker.ctyun.securityGroup.reader';
module(AWS_SECURITY_GROUP_READER, []).service('ctyunSecurityGroupReader', AwsSecurityGroupReader);
