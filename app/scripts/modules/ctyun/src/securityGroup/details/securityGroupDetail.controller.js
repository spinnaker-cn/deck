...
module.exports = angular
  .module('spinnaker.ctyun.securityGroup.details.controller', [
    require('@uirouter/angularjs').default,
    SECURITY_GROUP_READER,
    CONFIRMATION_MODAL_SERVICE,
    require('../clone/cloneSecurityGroup.controller').name,
  ])
  .controller('ctyunSecurityGroupDetailsCtrl', [
    '$scope',
    '$state',
    ...
    function($scope, $state, resolvedSecurityGroup, app, confirmationModalService, securityGroupReader, $uibModal) {
      ...
      $scope.detailsTemplateUrl = CloudProviderRegistry.getValue('ctyun', 'securityGroup.detailsTemplateUrl');
      ...
      this.editInboundRules = function editInboundRules() {
        $uibModal.open({
          ...
          controller: 'ctyunEditSecurityGroupCtrl as ctrl',
          size: 'lg',
          resolve: {
      ...
      this.cloneSecurityGroup = function cloneSecurityGroup() {
        $uibModal.open({
          ...
          controller: 'ctyunCloneSecurityGroupController as ctrl',
          size: 'lg',
          resolve: {
            securityGroup: function() {
