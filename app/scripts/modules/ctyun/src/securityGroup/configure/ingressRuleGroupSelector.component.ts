...
class IngressRuleSelectorController implements IController {
  ...
  public setAvailableSecurityGroups(): void {
    ...
    regions.forEach(region => {
      ...
      const regionalGroupNames = get(this.allSecurityGroups, [account, 'ctyun', region].join('.'), [])
...
export const INGRESS_RULE_GROUP_SELECTOR_COMPONENT = 'spinnaker.ctyun.securityGroup.configure.ingressRuleGroupSelector';
module(INGRESS_RULE_GROUP_SELECTOR_COMPONENT, []).component('ctyunIngressRuleGroupSelector', ingressRuleSelector);
