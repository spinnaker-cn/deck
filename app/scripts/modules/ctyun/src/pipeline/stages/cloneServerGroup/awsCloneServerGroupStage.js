...
module.exports = angular
  .module('spinnaker.ctyun.pipeline.stage.cloneServerGroupStage', [])
  .config(function() {
  ...
  .controller('ctyunCloneServerGroupStageCtrl', [
    '$scope',
    function($scope) {
      ...
      AccountService.listAccounts('ctyun').then(accounts => {
