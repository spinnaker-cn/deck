...
module.exports = angular
  .module('spinnaker.ctyun.pipeline.stage.bakeStage', [require('./bakeExecutionDetails.controller').name])
  .config(function() {
  ...
  .controller('ctyunBakeStageCtrl', [
    ...
    function($scope, $q, $uibModal) {
      ...
      function initialize() {
        $q.all({
          regions: BakeryReader.getRegions('ctyun'),
          baseOsOptions: BakeryReader.getBaseOsOptions('ctyun'),
          ...
          if (!$scope.stage.regions.length && $scope.application.defaultRegions.ctyun) {
            $scope.stage.regions.push($scope.application.defaultRegions.ctyun);
          }
          if (!$scope.stage.regions.length && $scope.application.defaultRegions.ctyun) {
            $scope.stage.regions.push($scope.application.defaultRegions.ctyun);
          }
          ...
          console.log('-------------------------------------');
          console.log('$scope.baseOsOptions', $scope.baseOsOptions);
          console.log('$scope.stage.baseOs', $scope.stage.baseOs);
          console.log('-------------------------------------');
