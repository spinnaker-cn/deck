...
module.exports = angular
  .module('spinnaker.ctyun.pipeline.stage.bake.executionDetails.controller', [require('@uirouter/angularjs').default])
  .controller('ctyunBakeExecutionDetailsCtrl', [
    '$scope',
    '$stateParams',
    ...
    function($scope, $stateParams, executionDetailsSectionService, $interpolate) {
      ...
      let initialized = () => {
        ...
        $scope.provider = $scope.stage.context.cloudProviderType || 'ctyun';
