...
import { AMAZON_INSTANCE_WRITE_SERVICE } from 'ctyun/instance/amazon.instance.write.service';

module.exports = angular
  .module('spinnaker.ctyun.instance.details.controller', [
  ...
  .controller('ctyunInstanceDetailsCtrl', [
    '$scope',
    '$state',
    '$uibModal',
    ...
    function(
      ...
      $scope.detailsTemplateUrl = CloudProviderRegistry.getValue('ctyun', 'instance.detailsTemplateUrl');
      ...
      function extractHealthMetrics(instance, latest) {
        ...
        var displayableMetrics = instance.health.filter(function(metric) {
          return metric.type !== 'ctyun' || metric.state !== 'Unknown';
        });
      ...
      function retrieveInstance() {
        ...
        if (instanceSummary && account && region) {
          ...
          return InstanceReader.getInstanceDetails(account, region, instance.instanceId).then(details => {
            ...
            $scope.instance.instanceIdStr = details.instanceId;
      ...
      this.terminateInstance = function terminateInstance() {
        ...
        var submitMethod = function() {
          return amazonInstanceWriter.ctyunTerminateInstance(instance, app, {
      ...
      this.terminateInstanceAndShrinkServerGroup = function terminateInstanceAndShrinkServerGroup() {
        ...
        var submitMethod = function() {
          return amazonInstanceWriter.ctyunTerminateInstanceAndShrinkServerGroup(instance, app, {
            instanceIds: [instance.instanceIdStr],
            cloudProvider: instance.cloudProvider,
            serverGroupName: instance.serverGroupName,
          });
        };
      ...
      this.rebootInstance = function rebootInstance() {
        ...
        var submitMethod = (params = {}) => {
          ...
          params.interestingHealthProviderNames = ['Ctyun'];
          // }
          return amazonInstanceWriter.ctyunRebootInstance(instance, app, params);
        };
