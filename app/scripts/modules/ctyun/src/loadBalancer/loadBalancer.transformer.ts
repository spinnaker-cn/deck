...
import { VpcReader } from 'ctyun/vpc/VpcReader';
...
export class AwsLoadBalancerTransformer {
  ...
  public convertNetworkLoadBalancerForEditing(
    ...
    const toEdit: IAmazonNetworkLoadBalancerUpsertCommand = {
      ...
      eipsList: loadBalancer.eipsList,
      eipId: loadBalancer.eipId,
    };
  ...
  public constructNewClassicLoadBalancerTemplate(application: Application): IAmazonClassicLoadBalancerUpsertCommand {
    const defaultCredentials = application.defaultCredentials.ctyun || AWSProviderSettings.defaults.account,
      defaultRegion = application.defaultRegions.ctyun || AWSProviderSettings.defaults.region,
...
export const AWS_LOAD_BALANCER_TRANSFORMER = 'spinnaker.ctyun.loadBalancer.transformer';
module(AWS_LOAD_BALANCER_TRANSFORMER, []).service('ctyunLoadBalancerTransformer', AwsLoadBalancerTransformer);
