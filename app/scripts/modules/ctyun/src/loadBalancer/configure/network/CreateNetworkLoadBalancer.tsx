...
import { IAmazonNetworkLoadBalancer, IAmazonNetworkLoadBalancerUpsertCommand } from 'ctyun/domain';
...
> {
  ...
  constructor(props: ICreateNetworkLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.loadBalancer
      ? AwsReactInjector.ctyunLoadBalancerTransformer.convertNetworkLoadBalancerForEditing(props.loadBalancer)
      : AwsReactInjector.ctyunLoadBalancerTransformer.constructNewNetworkLoadBalancerTemplate(props.app);
