...
import { IAmazonApplicationLoadBalancer, IAmazonApplicationLoadBalancerUpsertCommand } from 'ctyun/domain';
import { AwsReactInjector } from 'ctyun/reactShims';
...
> {
  ...
  constructor(props: ICreateApplicationLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.command
      ...
      : props.loadBalancer
      ? AwsReactInjector.ctyunLoadBalancerTransformer.convertApplicationLoadBalancerForEditing(props.loadBalancer)
      : AwsReactInjector.ctyunLoadBalancerTransformer.constructNewApplicationLoadBalancerTemplate(props.app);
    this.state = {
