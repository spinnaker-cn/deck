...
import { IAmazonClassicLoadBalancer, IAmazonClassicLoadBalancerUpsertCommand } from 'ctyun/domain';
...
> {
  ...
  constructor(props: ICreateClassicLoadBalancerProps) {
    ...
    const loadBalancerCommand = props.loadBalancer
      ? AwsReactInjector.ctyunLoadBalancerTransformer.convertClassicLoadBalancerForEditing(props.loadBalancer)
      : AwsReactInjector.ctyunLoadBalancerTransformer.constructNewClassicLoadBalancerTemplate(props.app);
