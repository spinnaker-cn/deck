...
import { IAmazonApplicationLoadBalancer, ITargetGroup } from 'ctyun/domain/IAmazonLoadBalancer';
...
export const AWS_TARGET_GROUP_DETAILS_CTRL = 'spinnaker.ctyun.loadBalancer.details.targetGroupDetails.controller';
module(AWS_TARGET_GROUP_DETAILS_CTRL, [require('@uirouter/angularjs').default]).controller(
  'ctyunTargetGroupDetailsCtrl',
