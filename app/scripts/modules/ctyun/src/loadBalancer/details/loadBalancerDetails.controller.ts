...
import { IAmazonLoadBalancer, IAmazonLoadBalancerSourceData, IListenerAction, ITargetGroup } from 'ctyun/domain';
...
export const AWS_LOAD_BALANCER_DETAILS_CTRL = 'spinnaker.ctyun.loadBalancer.details.controller';
module(AWS_LOAD_BALANCER_DETAILS_CTRL, [
  ...
  LOAD_BALANCER_READ_SERVICE,
  CONFIRMATION_MODAL_SERVICE,
]).controller('ctyunLoadBalancerDetailsCtrl', AwsLoadBalancerDetailsController);
