...
export const DETAILS_SUMMARY = 'spinnaker.ctyun.scalingPolicy.details.summary.component';
module(DETAILS_SUMMARY, []).component('ctyunScalingPolicySummary', scalingPolicyDetailsSummary);
