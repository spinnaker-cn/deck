...
module.exports = angular
  .module('spinnaker.ctyun.serverGroup.details.scalingPolicy.dimensionEditor', [])
    ...
    controller: function() {
      ...
      this.fetchDimensionOptions = () => {
        ...
        return Observable.fromPromise(
          CloudMetricsReader.listMetrics('ctyun', this.serverGroup.account, this.serverGroup.region, filters),
        );
      };
