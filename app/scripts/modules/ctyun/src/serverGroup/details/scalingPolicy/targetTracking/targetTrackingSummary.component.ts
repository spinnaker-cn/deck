...
import { ITargetTrackingConfiguration, ITargetTrackingPolicy } from 'ctyun/domain/ITargetTrackingPolicy';
...
export const TARGET_TRACKING_SUMMARY_COMPONENT = 'spinnaker.ctyun.scalingPolicy.targetTracking.summary.component';
