...
const stepPolicyActionComponent = {
  ...
  controller() {
    this.operatorChanged = () => {
      ...
      this.adjustmentTypeOptions = ['instances', 'percent of group'];
    };
...
export const STEP_POLICY_ACTION = 'spinnaker.ctyun.scalingPolicy.stepPolicy.action';
module(STEP_POLICY_ACTION, []).component('ctyunStepPolicyAction', stepPolicyActionComponent);
