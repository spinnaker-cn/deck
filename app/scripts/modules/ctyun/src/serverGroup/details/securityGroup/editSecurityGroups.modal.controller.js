...
module.exports = angular
  .module('spinnaker.ctyun.serverGroup.details.securityGroup.editSecurityGroups.modal.controller', [
    SERVER_GROUP_WRITER,
    SECURITY_GROUP_READER,
  ])
  .controller('ctyunEditSecurityGroupsCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'securityGroupReader',
    ...
    function(
      ...
      securityGroupReader.getAllSecurityGroups().then(allGroups => {
        ...
        this.availableSecurityGroups = _.get(allGroups, [account, 'ctyun', region].join('.'), [])
