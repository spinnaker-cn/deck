...
module.exports = angular
  .module('spinnaker.ctyun.serverGroup.details.rollback.controller', [SERVER_GROUP_WRITER])
  .controller('ctyunRollbackServerGroupCtrl', [
    '$scope',
    '$uibModalInstance',
    'serverGroupWriter',
    'application',
    ...
    function(
      ...
      if (application && application.attributes) {
        if (application.attributes.platformHealthOnlyShowOverride && application.attributes.platformHealthOnly) {
          $scope.command.interestingHealthProviderNames = ['ctyun'];
        }
