...
export const SERVER_GROUP_DETAILS_MODULE = 'spinnaker.ctyun.serverGroup.details';
module(SERVER_GROUP_DETAILS_MODULE, [
  ...
  require('./scheduledAction/createOrEditScheduledActions.modal.controller').name,
