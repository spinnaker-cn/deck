...
import { IAmazonServerGroupCommand, ICtyunDisk } from 'ctyun/serverGroup/configure/serverGroupConfiguration.service';
...
export class ServerGroupAdvancedSettingsCommon extends React.Component<IServerGroupAdvancedSettingsProps> {
  ...
  public validate = (values: IAmazonServerGroupCommand) => {
    ...
    if (!values.keyPair) {
      errors.keyPair = 'Key Name required.';
    }
  ...
  private dataDiskTypeChange = (dataDisk: ICtyunDisk, value: string) => {
    dataDisk.diskType = value;
    this.updateDataDisks();
  };

  private dataDiskSizeChange = (dataDisk: ICtyunDisk, value: number) => {
    dataDisk.diskSize = value;
    this.updateDataDisks();
  };

  private dataDiskSnapshotIdChange = (dataDisk: ICtyunDisk, value: string) => {
  ...
  public render() {
    ...
    return (
      <div className="container-fluid form-horizontal">
        ...
        {values.internetAccessible.publicIpAssigned === true && (
          <div className="form-group">
            <div className="col-md-5 sm-label-right">
              <b>Network Billing</b>
            </div>
            <div className="col-md-3 radio">
              <label>
                <input
                  type="radio"
                  checked={values.internetAccessible.internetChargeType == 1}
                  onChange={() =>
            ...
            <div className="col-md-2 radio">
              <label>
                <input
                  type="radio"
                  checked={values.internetAccessible.internetChargeType === 2}
                  onChange={() =>
                    setFieldValue('internetAccessible', {
                      ...values.internetAccessible,
        ...
        {values.internetAccessible.publicIpAssigned === true && values.internetAccessible.internetChargeType == 1 && (
          <div className="form-group">
            <div className="col-md-5 sm-label-right">
              <b>Bandwidth</b>
            </div>
        ...
        <div className="form-group">
          ...
          <div className="col-md-3" style={{ paddingRight: 0 }}>
            <Select
              ...
              options={values.backingData.diskTypes.map(m => ({ label: m.label, value: m.value }))}
