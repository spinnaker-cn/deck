...
import { SubnetSelectField } from 'ctyun/subnet';
...
export class ServerGroupBasicSettings
  ...
  private recoveryModeChanged = (event: React.ChangeEvent<any>): void => {
    const { setFieldValue, values } = this.props.formik;
    values.recoveryMode = event.target.value;
    setFieldValue('recoveryMode', event.target.value);
  };

  private healthModeChanged = (event: React.ChangeEvent<any>): void => {
    const { setFieldValue, values } = this.props.formik;
    values.healthMode = event.target.value;
    setFieldValue('healthMode', event.target.value);
  };

  private healthPeriodChanged = (event: React.ChangeEvent<any>): void => {
    const { setFieldValue, values } = this.props.formik;
    values.healthPeriod = event.target.value;
    setFieldValue('healthPeriod', event.target.value);
  };

  private projectIDChanged = (event: React.ChangeEvent<any>): void => {
    const { setFieldValue, values } = this.props.formik;
    values.projectID = event.target.value;
    setFieldValue('projectID', event.target.value);
  };

  private moveOutStrategyChanged = (event: React.ChangeEvent<any>): void => {
    const { setFieldValue, values } = this.props.formik;
    values.moveOutStrategy = event.target.value;
    setFieldValue('moveOutStrategy', event.target.value);
  };
  ...
  public render() {
    ...
    return (
      <div className="container-fluid form-horizontal">
        ...
        {!(values.optionZone && values.optionZone.length > 0) && (
          <SubnetSelectField
        ...
        {/* <div className="form-group">
          <div className="col-md-3 sm-label-right">
            moveOutStrategy <HelpField id="aws.serverGroup.moveOutStrategy" />
          </div>
          <div className="col-md-7">
            <SelectInput
              inputClassName="form-control input-sm"
              value={values.moveOutStrategy}
              options={[
                {
                  label: 'Configuration created earlier created earlier',
                  value: '1',
                },
                {
                  label: 'Configuration created later created later',
                  value: '2',
                },
                {
                  label: 'Created earlier',
                  value: '3',
                },
                {
                  label: 'Create Later',
              ...
              onChange={this.moveOutStrategyChanged}
            />
          </div>
        </div> */}

        <div className="form-group">
          <div className="col-md-3 sm-label-right marginT7">
            Recover mode <HelpField id="aws.serverGroup.releaseMode" />
          </div>
          {/* <div className="col-md-7">
            <SelectInput
              inputClassName="form-control input-sm"
              value={values.recoveryMode}
              options={[{
                label: 'release mode',
                value: '1'
              }, {
                label: 'Shutdown recycling mode',
                value: '2'
              }]}
              onChange={this.recoveryModeChanged}
            />
          </div> */}
          <div className="col-md-3 radio marginB7">
            <label>
              <input
                type="radio"
                checked={values.recoveryMode == 1}
                onChange={() => formik.setFieldValue('recoveryMode', 1)}
              />
              release mode
            </label>
          </div>
          <div className="col-md-4 radio">
            <label>
              <input
                type="radio"
                checked={values.recoveryMode == 2}
                onChange={() => formik.setFieldValue('recoveryMode', 2)}
              />
              Shutdown recycling mode
            </label>
          </div>
        </div>
        ...
        {/* <div className="form-group">
          ...
          <div className="col-md-7">
            <SelectInput
              inputClassName="form-control input-sm"
              value={values.healthMode}
              options={[
                {
                  label: 'Cloud Server Health Check',
                  value: '1',
                },
                {
                  label: 'Elastic Load Balancing Health Check',
                  value: '2',
                },
              ]}
        ...
        <div className="form-group">
          ...
          <div className="col-md-7">
            <SelectInput
              ...
              onChange={this.healthPeriodChanged}
            />
          </div>
        </div>
        {/* <div className="form-group">
          ...
          <div className="col-md-7">
            <SelectInput
              ...
              onChange={this.projectIDChanged}
            />
          </div>
        </div> */}
        <div className="form-group">
