...
export const AWSProviderSettings: IAWSProviderSettings = (SETTINGS.providers.tencent as IAWSProviderSettings) || {
  defaults: {},
};
if (AWSProviderSettings) {
  AWSProviderSettings.resetToOriginal = SETTINGS.resetProvider('tencent');
}
